/* Service worker Demo: web push + offline app-shell.
   ...
   Let op de paden: deze worker draait onder /demo/; gedeelde assets staan op
...
self.addEventListener('activate', (e) => e.waitUntil((async () => {
  ...
  await Promise.all(sleutels
    .filter((k) => k !== CACHE && (k.startsWith('demo-shell') || k === 'shell'))
