...
icon = b64("docs/logo-rond-512.png")

CSS = """
* { margin:0; padding:0; box-sizing:border-box; }
html,body { width:1080px; height:1080px; overflow:hidden; }
body { font-family:'Montserrat','Avenir Next','Segoe UI',Roboto,Helvetica,Arial,sans-serif; position:relative; }
...
.badge { width:170px; height:170px; display:block; }
.oranje { color:#f0a04b; }
